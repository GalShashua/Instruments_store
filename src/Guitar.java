...
public class Guitar extends StringInstrument {
	...
	private void checkNumOfString(int numOfStrings) {
		switch (indexOfType()) {
		case CLASSIC:
		...
		case ELECTRIC:
			if (numOfStrings < ELEC_MIN_NUM_OF_STRINGS || numOfStrings > ELEC_MAX_NUM_OF_STRINGS)
				throw new InputMismatchException("Electric Guitars have 6 strings, not " + numOfStrings);
			break;
		}
	}
	...
	public Guitar clone() throws CloneNotSupportedException {
		return new Guitar(getBrand(), getPrice(), getNumOfStrings(), getType());
	}
